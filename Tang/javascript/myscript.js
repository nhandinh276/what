...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim của tui lúc này kiểu: " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Thấy bà chơi liên quân chiến quá, mê luôn kakaka <i class="fas fa-heart"></i> ';
